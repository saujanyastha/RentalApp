<x-app-layout>
    ...
    <div class="container">
        {{-- The <h1> tag is now handled by x-slot name="header" --}}
        ...
        <form action="{{ route('vehicles.store') }}" method="POST">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="make_year" name="make_year" value="{{ old('make_year') }}">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="engine_no" name="engine_no" value="{{ old('engine_no') }}" required>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="vehicle_no" name="vehicle_no" value="{{ old('vehicle_no') }}" required>
            ...
            <div class="form-group">
                ...
                <input type="text" id="chassis_no" name="chassis_no" value="{{ old('chassis_no') }}" required>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" id="purchased_price" name="purchased_price" value="{{ old('purchased_price') }}">
                    @error('purchased_price') <p class="error-message">{{ $message }}</p> @enderror
                </div>

                <div class="form-group">
                    <label for="purchased_date">Purchased Date (Optional):</label>
                    <input type="date" id="purchased_date" name="purchased_date" value="{{ old('purchased_date') }}">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="date" id="tax_renewal_date" name="tax_renewal_date" value="{{ old('tax_renewal_date') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="insurance_renewal_date" name="insurance_renewal_date" value="{{ old('insurance_renewal_date') }}">
